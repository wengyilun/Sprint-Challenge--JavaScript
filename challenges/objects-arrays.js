...
console.log(`tyrannosaurut's weight is ${tyrannosaurus.weight}`);

// What was the diet of a velociraptor?
console.log(`velociraptor is ${velociraptor.diet}`)

// How long was a stegosaurus?
console.log(`stegosaurus is ${stegosaurus.length} long`)


// What time period did tyrannosaurus live in?
console.log(`tyrannosaurus lives in ${tyrannosaurus.period}`)


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`tyrannosaurut says ${tyrannosaurus.roar()}`)
